...
const tld = ".svnt";
const CONTRACT_ADDRESS = domainsAddress;
...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img
        src="https://media.giphy.com/media/Et9npHyGSF20w/giphy.gif"
        alt="Dragon gif"
      />
      <button
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="What is burning today?"
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🐲 🐉 🔥 Dragons Name Service</p>
              <p className="subtitle">Burning up the blockchain!</p>
            </div>
            <div className="right round-and-gradient">
              <img
                alt="Network logo"
                className="logo"
